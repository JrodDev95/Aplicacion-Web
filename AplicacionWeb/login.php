...
// Incluimos la configuracion para que se conecte a la base de datos
require_once("config/db.php");

// carga el archivo  login
...
<head>
  ...
  <title>Proyecto Desarollo Web | Login</title>
