<?php
	...
	$active_clientes="";
	$active_usuarios="";	
	$title="Editar Factura | Proyecto Desarollo Web ";
	...
	if (isset($_GET['id_factura']))
	{
		...
		$campos="clientes.id_cliente, clientes.nombre_cliente, clientes.apellido_cliente, clientes.NIT_cliente, facturas.id_vendedor, facturas.fecha_factura, facturas.condiciones, facturas.estado_factura, facturas.numero_factura";
		...
		if ($count==1)
		{
				...
				$telefono_cliente=$rw_factura['apellido_cliente'];
				$email_cliente=$rw_factura['NIT_cliente'];
		...
		?>
			<form class="form-horizontal" role="form" id="datos_factura">
				<div class="form-group row">
				  ...
				  <label for="tel1" class="col-md-1 control-label">Apellido</label>
							<div class="col-md-2">
								<input type="text" class="form-control input-sm" id="tel1" placeholder="Apellido" value="<?php echo $telefono_cliente;?>" readonly>
							</div>
					<label for="mail" class="col-md-1 control-label">NIT</label>
							<div class="col-md-3">
								<input type="text" class="form-control input-sm" id="mail" placeholder="NIT" readonly value="<?php echo $email_cliente;?>">
							</div>
				 </div>
						<div class="form-group row">
		...
		$(function() {
						$("#nombre_cliente").autocomplete({
							...
							select: function(event, ui) {
								...
								$('#tel1').val(ui.item.apellido_cliente);
								$('#mail').val(ui.item.NIT_cliente);
