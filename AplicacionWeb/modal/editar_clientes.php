		  ...
		  <div class="modal-body">
			...
			<div id="resultados_ajax2"></div>
			  <div class="form-group">
			   ...
			   <div class="form-group">
				<label for="mod_telefono" class="col-sm-3 control-label">Apellido</label>
				<div class="col-sm-8">
			  ...
			  <div class="form-group">
				<label for="mod_email" class="col-sm-3 control-label">NIT</label>
				<div class="col-sm-8">
				 <input type="text
				 " class="form-control" id="mod_email" name="mod_email">
				</div>
			  </div>
			  <div class="form-group">
